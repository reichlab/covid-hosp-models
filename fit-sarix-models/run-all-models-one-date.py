...
def load_data(as_of = '2022-04-18'):
  ...
  case_df = case_df[['location', 'date', 'corrected_case_rate_sqrt',
    'corrected_case_rate_sqrt_taylor_0', 'corrected_case_rate_fourthrt',
    'corrected_case_rate_fourthrt_taylor_0']]
...
def fit_sarix_variation(covariates, smooth_covariates, transform, p, d, P, D, pooling, location, forecast_date):
  ...
  model_name = build_model_name(covariates, smooth_covariates, transform, p, d, P, D)
