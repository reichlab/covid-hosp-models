# R CMD BATCH --vanilla '--args CA FL GA IL US' fit-sarix-models/drop_locations.R
...
latest_file <- max(Sys.glob('weekly-submission/sarix-forecasts/hosps/UMass-sarix/*.csv'))
